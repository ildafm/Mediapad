...
import static com.kelompok06_RPL.mediapad.VideoFileActivity.MY_PREF;
...
public class PlaylistDialog extends BottomSheetDialogFragment {
    ...
    public PlaylistDialog(ArrayList<FileMedia> arrayList, VideoFIleAdapter videoFIleAdapter) {
    ...
    public Dialog onCreateDialog(@Nullable Bundle savedInstanceState) {
        ...
        View view = LayoutInflater.from(getContext()).inflate(R.layout.playlist_vid, null);
        bottomSheetDialog.setContentView(view);

        recyclerView = view.findViewById(R.id.rcv_playlist);
        ...
        String folderName = preferences.getString("playlistFolderName","xyz");
